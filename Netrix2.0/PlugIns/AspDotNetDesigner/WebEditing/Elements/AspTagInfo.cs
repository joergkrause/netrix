...
namespace GuruComponents.Netrix.WebEditing.Elements
{
	...
	/// </remarks>
    public class AspTagInfo : ITagInfo
    {
        ...
        public AspTagInfo(string tagName, FormattingFlags flags) : this(tagName, flags, WhiteSpaceType.CarryThrough, WhiteSpaceType.CarryThrough, ElementType.Other)
        {
        }
        /// <summary>
        /// Creates a new tag info with basic parameters. 
        ...
        public AspTagInfo(string tagName, FormattingFlags flags, WhiteSpaceType innerWhiteSpace, WhiteSpaceType followingWhiteSpace) : this(tagName, flags, innerWhiteSpace, followingWhiteSpace, ElementType.Other)
        {
        }
        /// <summary>
        /// Creates a new tag info with basic parameters. 
        ...
        public AspTagInfo(string newTagName, ITagInfo info)
        {
