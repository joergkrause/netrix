...
namespace GuruComponents.Netrix.WebEditing.Elements.Html5
{
    ...
    /// </example>
    /// </remarks>
    public class NavElement : Html5Base
    {
        ...
        public NavElement(IHtmlEditor editor)
            : base("nav", editor)
        {
        }

        internal NavElement(Interop.IHTMLElement peer, HtmlEditor editor)
            : base(peer, editor)
        {
        }
    }
