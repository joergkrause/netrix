...
namespace GuruComponents.Netrix.VmlDesigner.Elements
{
	...
	public class ElementDom : IElementDom
	{
		...
		internal ElementDom(Interop.IHTMLDOMNode Element, IHtmlEditor htmlEditor) 
		{	
            this.node = Element;
        ...
        public IElement RemoveChild (IElement oldChild)
        {
            ...
            {
                oc = oldChild.GetBaseElement() as Interop.IHTMLDOMNode;
            }           
            try
            {
        ...
        public IElement ReplaceChild (IElement oldChild, IElement newChild)
        {
            ...
            {
                rc = oldChild.GetBaseElement() as Interop.IHTMLDOMNode;
            }            
            try
            {
                if (rc != null && nc != null)
                {
                    return this.htmlEditor.GenericElementFactory.CreateElement((Interop.IHTMLElement)node.replaceChild(nc, rc)) as IElement;
                }
                else
                {
                    return null;
        ...
        public IElement AppendChild (IElement newChild)
        {
            ...
            try
            {
                if (nc != null)
                {
                    Interop.IHTMLDOMNode newNode = node.appendChild(nc);
                    if (newNode != null)
                    {
                        return this.htmlEditor.GenericElementFactory.CreateElement((Interop.IHTMLElement)newNode) as IElement;
                    }
                }
                return null;
            }
            ...
            {
                System.Diagnostics.Debug.WriteLine(ex.Message, "ElementDom:AppendChild");
                return null;                                
            }
        }
