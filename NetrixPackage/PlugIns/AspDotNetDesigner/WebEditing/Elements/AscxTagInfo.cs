...
namespace GuruComponents.Netrix.WebEditing.Elements
{
	...
	/// </remarks>
    public class AscxTagInfo : ITagInfo
    {
        ...
        public string TagName
        {
            get
            {
                return String.Concat(_alias, ":", _tagName);
            }
        }
        ...
        public AscxTagInfo(string tagName, FormattingFlags flags, ElementType type) : this(tagName, flags, WhiteSpaceType.CarryThrough, WhiteSpaceType.CarryThrough, type)
        {
        }
        /// <summary>
        /// Creates a new tag info with basic parameters. 
        ...
        public AscxTagInfo(string tagName, FormattingFlags flags, WhiteSpaceType innerWhiteSpace, WhiteSpaceType followingWhiteSpace) : this(tagName, flags, innerWhiteSpace, followingWhiteSpace, ElementType.Other)
        {
        }
        /// <summary>
        /// Creates a new tag info with basic parameters. 
        ...
        private void SetTagName(string tagName)
        {
            ...
            {
                string[] ns = tagName.Split(':');
                _alias = ns[0];
                _tagName = ns[1];
            }
            else
            {
                throw new ArgumentException("ASCX Controls must have an alias (expected 'alias:name')", "tagName");
            }
        }
