...
namespace GuruComponents.Netrix.WebEditing.Elements
{
    ...
    /// </para>
    /// </remarks>
    public sealed class DeletedElement : StyledElement
    {
        ...
        public DeletedElement(IHtmlEditor editor)
            : base("del", editor)
        {
        }

        internal DeletedElement (Interop.IHTMLElement peer, IHtmlEditor editor) : base (peer, editor)
        {
        } 
    }
}