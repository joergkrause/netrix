...
namespace Comzept.Genesis.Tidy.Dom
{
	...
	public interface Document:Node
	{
		...
		/// illegal character.
		/// </exception>
		Element createElement(System.String tagName);
		...
		/// <param name="data">data for the node.
		/// </param>
		/// <returns> The new <code>Text</code> object.
		/// </returns>
		Text createTextNode(System.String data);
		...
		/// </returns>
		Comment createComment(System.String data);
		
		/// <summary> Creates a <code>CDATASection</code> node whose value is the specified 
		/// string.
		/// </summary>
		/// <param name="data">data for the <code>CDATASection</code> contents.
		/// </param>
		/// <returns> The new <code>CDATASection</code> object.
		/// </returns>
		/// <exception cref="DOMException">NOT_SUPPORTED_ERR: Raised if this document is an HTML document.
		/// </exception>
		CDATASection createCDATASection(System.String data);
		
		/// <summary> Creates a <code>ProcessingInstruction</code> node given the specified 
		/// name and data strings.
		/// </summary>
		/// <param name="target">target part of the processing instruction.
		/// </param>
		/// <param name="data">data for the node.
		/// </param>
		/// <returns> The new <code>ProcessingInstruction</code> object.
		/// </returns>
		/// <exception cref="DOMException">INVALID_CHARACTER_ERR: Raised if the specified target contains an 
		/// illegal character.
		/// <br/>NOT_SUPPORTED_ERR: Raised if this document is an HTML document.
		/// </exception>
		ProcessingInstruction createProcessingInstruction(System.String target, System.String data);
		...
		/// illegal character.
		/// </exception>
		Attr createAttribute(System.String name);
		...
		/// </summary>
		/// <param name="name">name of the entity to reference. 
		/// </param>
		...
		/// <br/>NOT_SUPPORTED_ERR: Raised if this document is an HTML document.
		/// </exception>
		EntityReference createEntityReference(System.String name);
		...
		/// <code>Elements</code>.
		/// </returns>
		NodeList getElementsByTagName(System.String tagname);
		...
		/// 
		/// </summary>
		/// <param name="importedNode">node to import.
		/// </param>
		...
		/// </param>
		/// <returns> The imported node that belongs to this <code>Document</code>.
		/// </returns>
		/// <exception cref="DOMException">NOT_SUPPORTED_ERR: Raised if the type of node being imported is not 
		/// supported.
		/// </exception>
		/// <since> DOM Level 2
		/// </since>
		...
		/// <since> DOM Level 2
		/// </since>
		Element createElementNS(System.String namespaceURI, System.String qualifiedName);
		...
		/// <since> DOM Level 2
		/// </since>
		Attr createAttributeNS(System.String namespaceURI, System.String qualifiedName);
		...
		/// </summary>
		/// <param name="elementId">unique <code>id</code> value for an element.
		/// </param>
		/// <returns> The matching element.
		/// </returns>
		/// <since> DOM Level 2
		/// </since>
		Element getElementById(System.String elementId);
	}
}