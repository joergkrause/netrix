...
namespace Comzept.Genesis.Tidy.Dom
{
	...
	public interface DOMImplementation
	{
		...
		/// <summary> Creates an empty <code>DocumentType</code> node. </summary>
        /// <remarks>Entity declarations 
		...
		/// created. 
		/// </param>
		/// <param name="publicId">external subset public identifier.
		/// </param>
		/// <param name="systemId">external subset system identifier.
		/// </param>
		...
		/// <since> DOM Level 2
		/// </since>
		DocumentType createDocumentType(System.String qualifiedName, System.String publicId, System.String systemId);
		
		/// <summary> Creates an XML <code>Document</code> object of the specified type with 
		/// its document element. HTML-only DOM implementations do not need to 
		/// implement this method.
		/// </summary>
		/// <param name="namespaceURI">namespace URI of the document element to create.
		/// </param>
		/// <param name="qualifiedName">qualified name of the document element to be 
		/// created.
		/// </param>
		...
		/// being created.
		/// </param>
		/// <returns> A new <code>Document</code> object.
		/// </returns>
		/// <exception cref="DOMException">INVALID_CHARACTER_ERR: Raised if the specified qualified name 
		/// contains an illegal character.
		/// <br/>NAMESPACE_ERR: Raised if the <code>qualifiedName</code> is 
		...
		/// <since> DOM Level 2
		/// </since>
		Document createDocument(System.String namespaceURI, System.String qualifiedName, DocumentType doctype);
	}
}