...
namespace GuruComponents.Netrix.UserInterface.TypeEditors
{
    ...
    /// </remarks>
    public class MetaCollectionEditor : CollectionEditor
    {
        ...
        public MetaCollectionEditor(Type type) : base(type)
        {
        }
        ...
        protected override CollectionForm CreateCollectionForm()
        {
            ...
            if (fieldInfo != null)
            {
                propertyGrid = (PropertyGrid) fieldInfo.GetValue(form);
			...
			if (fieldInfo != null)
			{
				...
				removeButton.Text = ResourceManager.GetString("MetaCollectionEditor.removeButton.Text");
			...
			if (fieldInfo != null)
			{
				...
				addButton.Text = ResourceManager.GetString("MetaCollectionEditor.addButton.Text");
            ...
            memberLabel.Text = ResourceManager.GetString("MetaCollectionEditor.memberLabel.Text");
