...
namespace Comzept.Genesis.Tidy.Dom
{
	...
	public interface CharacterData:Node
	{
		...
		/// <param name="offset">offset of substring to extract.
		/// </param>
		/// <param name="count">number of 16-bit units to extract.
		/// </param>
		/// <returns> The specified substring. If the sum of <code>offset</code> and 
		/// <code>count</code> exceeds the <code>length</code>, then all 16-bit 
		/// units to the end of the data are returned.
		/// </returns>
		/// <exception cref="DOMException">INDEX_SIZE_ERR: Raised if the specified <code>offset</code> is 
		...
		/// </summary>
		/// <param name="arg"><code>DOMString</code> to append.
		/// </param>
		/// <exception cref="DOMException">NO_MODIFICATION_ALLOWED_ERR: Raised if this node is readonly.
		/// </exception>
		void  appendData(System.String arg);
		
		/// <summary> Insert a string at the specified 16-bit unit offset.</summary>
		/// <param name="offset">character offset at which to insert.
		/// </param>
		/// <param name="arg"><code>DOMString</code> to insert.
		/// </param>
		/// <exception cref="DOMException">INDEX_SIZE_ERR: Raised if the specified <code>offset</code> is 
		/// negative or greater than the number of 16-bit units in 
		/// <code>data</code>.
		...
		/// </exception>
		void  insertData(int offset, System.String arg);
		
		/// <summary> Remove a range of 16-bit units from the node. Upon success, 
		/// <code>data</code> and <code>length</code> reflect the change.
		/// </summary>
		/// <param name="offse">offset from which to start removing.
		/// </param>
		...
		/// </summary>
		/// <param name="offset">offset from which to start replacing.
		/// </param>
		...
		/// <br/>NO_MODIFICATION_ALLOWED_ERR: Raised if this node is readonly.
		/// </exception>
		void  replaceData(int offset, int count, System.String arg);
	}
}