...
{
	/// <summary>
	/// This class is used to store information about the way the formatter treats an element.
	/// </summary>
	/// <remarks>
	...
	/// </remarks>
    public class XmlTagInfo : ITagInfo
    {
        ...
        public string TagName
        {
            get
            {
                if (_ns != null && _ns != String.Empty)
                    return String.Concat(_ns, ":", _tagName);
                else
                    return _tagName;
            }
        }
        ...
        public XmlTagInfo(string tagName, FormattingFlags flags) : this(tagName, flags, WhiteSpaceType.CarryThrough, WhiteSpaceType.CarryThrough, ElementType.Other)
        {
        }
        /// <summary>
        /// Creates a new tag info with basic parameters. 
        ...
        public XmlTagInfo(string tagName, FormattingFlags flags, ElementType type) : this(tagName, flags, WhiteSpaceType.CarryThrough, WhiteSpaceType.CarryThrough, type)
        {
        }
        /// <summary>
        /// Creates a new tag info with basic parameters. 
        ...
        public XmlTagInfo(string tagName, FormattingFlags flags, WhiteSpaceType innerWhiteSpace, WhiteSpaceType followingWhiteSpace) : this(tagName, flags, innerWhiteSpace, followingWhiteSpace, ElementType.Other)
        {
        }
        /// <summary>
        /// Creates a new tag info with basic parameters. 
