...
namespace Comzept.Genesis.Tidy.Dom
{
	...
	/// </summary>
	public struct Node_Fields{
		// NodeType
		/// <summary> The node is an <code>Element</code>.</summary>
		public readonly static short ELEMENT_NODE = 1;
		/// <summary> The node is an <code>Attr</code>.</summary>
		public readonly static short ATTRIBUTE_NODE = 2;
		/// <summary> The node is a <code>Text</code> node.</summary>
		public readonly static short TEXT_NODE = 3;
		/// <summary> The node is a <code>CDATASection</code>.</summary>
		public readonly static short CDATA_SECTION_NODE = 4;
		/// <summary> The node is an <code>EntityReference</code>.</summary>
		public readonly static short ENTITY_REFERENCE_NODE = 5;
		/// <summary> The node is an <code>Entity</code>.</summary>
		public readonly static short ENTITY_NODE = 6;
		/// <summary> The node is a <code>ProcessingInstruction</code>.</summary>
		public readonly static short PROCESSING_INSTRUCTION_NODE = 7;
		/// <summary> The node is a <code>Comment</code>.</summary>
		public readonly static short COMMENT_NODE = 8;
		/// <summary> The node is a <code>Document</code>.</summary>
		public readonly static short DOCUMENT_NODE = 9;
		/// <summary> The node is a <code>DocumentType</code>.</summary>
		public readonly static short DOCUMENT_TYPE_NODE = 10;
		/// <summary> The node is a <code>DocumentFragment</code>.</summary>
		public readonly static short DOCUMENT_FRAGMENT_NODE = 11;
		/// <summary> The node is a <code>Notation</code>.</summary>
		public readonly static short NOTATION_NODE = 12;
	}
	public interface Node
	{
		//UPGRADE_NOTE: Members of interface 'Node' were extracted into structure 'Node_Fields'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1045'"
		...
		/// </exception>
		/// <exception cref="DOMException">DOMSTRING_SIZE_ERR: Raised when it would return more characters than 
		...
		/// </summary>
		/// <exception cref="DOMException">INVALID_CHARACTER_ERR: Raised if the specified prefix contains an 
		/// illegal character.
		...
		/// </summary>
		/// <param name="newChild">node to insert.
		/// </param>
		...
		/// </returns>
		/// <exception cref="DOMException">HIERARCHY_REQUEST_ERR: Raised if this node is of a type that does not 
		...
		/// is first removed.
		/// </summary>
		/// <param name="newChild">new node to put in the child list.
		/// </param>
		/// <param name="oldChild">node being replaced in the list.
		/// </param>
		...
		/// </summary>
		/// <param name="oldChild">node being removed.
		/// </param>
		...
		/// <since> DOM Level 2
		/// </since>
		bool isSupported(System.String feature, System.String version);
