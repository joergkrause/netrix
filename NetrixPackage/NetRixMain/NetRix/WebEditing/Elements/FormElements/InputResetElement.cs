...
namespace GuruComponents.Netrix.WebEditing.Elements
{
    ...
    public sealed class InputResetElement : InputButtonElement
    {
        ...
        public InputResetElement(IHtmlEditor editor)
            : base(@"input type=""reset""", editor)
        {
        }


        internal InputResetElement(Interop.IHTMLElement peer, IHtmlEditor editor) : base (peer, editor)
        {
        }
    }
