...
namespace GuruComponents.Netrix.WebEditing.Elements
{
    ...
    public class InputButtonElement : InputElement
    {
        ...
        public InputButtonElement(IHtmlEditor editor)
            : base(@"input type=""button""", editor)
        {
        }

        protected InputButtonElement(string tag, IHtmlEditor editor)
            : base(tag, editor)
        {
        }

        internal InputButtonElement(Interop.IHTMLElement peer, IHtmlEditor editor) : base (peer, editor)
        {
        }
    }
