...
namespace GuruComponents.Netrix.HtmlFormatting
{
    ...
    public sealed class HtmlFormatterOptions : IHtmlFormatterOptions
    {
       ...
       Category("Formatting"), DefaultValue(false)]
        ...
        /// <summary>
        /// Set the case of attributes. Does not work if <see cref="MakeXhtml"/> is set to <c>true</c>.
        /// </summary>
        /// <remarks>
        /// If <code>true</code> all attribute names are upper case.
        /// </remarks>
        [Browsable(true), Description("Set the case of attributes. Does not work if MakeXhtml is set to true."),
       Category("Attributes"), DefaultValue(HtmlFormatterCase.LowerCase)]
      ...
      Category("Entities"), DefaultValue(typeof(EntityFormat), "Named")]
        ...
        /// <summary>
        /// Set the case of element names. Does not work if <see cref="MakeXhtml"/> is set to <c>true</c>.
        /// </summary>
        /// <remarks>
        /// If <code>true</code> all element names are upper case.
        /// </remarks>
        [Browsable(true), Description("Set the case of element names. Does not work if MakeXhtml is set to true."),
           Category("Formatting"), DefaultValue(HtmlFormatterCase.LowerCase)]
