...
namespace GuruComponents.Netrix.WebEditing.Elements.Html5
{
    ...
    /// </example>
    /// </remarks>
    public class MarkElement : Html5Base
    {
        ...
        public MarkElement(IHtmlEditor editor)
            : base("mark", editor)
        {
        }

        internal MarkElement(Interop.IHTMLElement peer, HtmlEditor editor)
            : base(peer, editor)
        {
        }
    }
