...
namespace Comzept.Genesis.Tidy.Dom
{
	...
	public interface NamedNodeMap
	{
		...
		/// <param name="name"><code>nodeName</code> of a node to retrieve.
		/// </param>
		/// <returns> A <code>Node</code> (of any type) with the specified 
		/// <code>nodeName</code>, or <code>null</code> if it does not identify 
		/// any node in this map.
		/// </returns>
		Node getNamedItem(System.String name);
		...
		/// is returned.
		/// </returns>
		/// <exception cref="DOMException">WRONG_DOCUMENT_ERR: Raised if <code>arg</code> was created from a 
		...
		/// </summary>
		/// <param name="name"><code>nodeName</code> of the node to remove.
		/// </param>
		/// <returns> The node removed from this map if a node with such a name 
		/// exists.
		/// </returns>
		/// <exception cref="DOMException">NOT_FOUND_ERR: Raised if there is no node named <code>name</code> in 
		/// this map.
		/// <br/>NO_MODIFICATION_ALLOWED_ERR: Raised if this map is readonly.
		/// </exception>
		Node removeNamedItem(System.String name);
		
		/// <summary> Returns the <code>index</code>th item in the map. If <code>index</code> 
		/// is greater than or equal to the number of nodes in this map, this 
		/// returns <code>null</code>.
		/// </summary>
		/// <param name="indexIndex">into this map.
		/// </param>
		...
		/// </summary>
		/// <param name="namespaceURI">namespace URI of the node to retrieve.
		/// </param>
		/// <param name="localName">local name of the node to retrieve.
		/// </param>
		...
		/// <since> DOM Level 2
		/// </since>
		Node getNamedItemNS(System.String namespaceURI, System.String localName);
		...
		/// <br/>HTML-only DOM implementations do not need to implement this method.
		/// </summary>
		/// <param name="namespaceURI">namespace URI of the node to remove.
		/// </param>
		/// <param name="localName">local name of the node to remove.
		/// </param>
		/// <returns> The node removed from this map if a node with such a local 
		/// name and namespace URI exists.
		/// </returns>
		/// <exception cref="DOMException">NOT_FOUND_ERR: Raised if there is no node with the specified 
		/// <code>namespaceURI</code> and <code>localName</code> in this map.
		/// <br/>NO_MODIFICATION_ALLOWED_ERR: Raised if this map is readonly.
		/// </exception>
		/// <since> DOM Level 2
		/// </since>
		Node removeNamedItemNS(System.String namespaceURI, System.String localName);
	}
}