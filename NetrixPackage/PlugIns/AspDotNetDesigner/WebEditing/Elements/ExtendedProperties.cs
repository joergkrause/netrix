...
namespace GuruComponents.Netrix.WebEditing.Elements
{
    ...
    /// </para>
    /// </remarks>
    public sealed class GenericPropertiesEx : IExtendedProperties
    {
        ...
        internal GenericPropertiesEx(Interop.IHTMLElement peer)
        {
            element = peer;
        }
        ...
        public System.Drawing.Rectangle AbsoluteArea
        {
            get
            {
                Interop.IHTMLRect rect = (Interop.IHTMLRect)el2.GetBoundingClientRect();
                System.Drawing.Rectangle r = new System.Drawing.Rectangle(
                    rect.left,
                    rect.top,
        ...
        {
            ((Interop.IHTMLElement3)element).setActive();
        }
        ...
        public bool HideFocus
        {
            get
            {
                return ((Interop.IHTMLElement3)element).hideFocus;
            }
            set
            {
                ((Interop.IHTMLElement3)element).hideFocus = value;
            }
        }
