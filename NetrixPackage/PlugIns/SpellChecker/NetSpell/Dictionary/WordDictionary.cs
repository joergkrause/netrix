...
namespace GuruComponents.Netrix.SpellChecker.NetSpell.Dictionary
{
    ...
    public class WordDictionary
    {
        ...
        private Dictionary<string, Word> _userWords = new Dictionary<string, Word>();
        ...
        private void LoadUserFile()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("Loading User Dictionary:{0}", filePath);
                ...
                while (sr.Peek() >= 0)
                {
                    ...
                    {
                        _userWords.Add(tempLine, new Word(tempLine));
                    }
                }
                ...
                System.Diagnostics.Debug.WriteLine(_userWords.Count, "Loaded User Dictionary; Words: ");
            }
        }
        ...
        private void SaveUserFile()
        {
            ...
            System.Diagnostics.Debug.WriteLine("Saving User Dictionary:{0}", filePath);
            ...
            System.Diagnostics.Debug.WriteLine(_userWords.Count, "Saved User Dictionary; Words: ");
        }
        ...
        {
            _userWords.Add(word, new Word(word));
            this.SaveUserFile();
        }
        ...
        public string DictionaryFile
        {
            ...
            set
            {
                string dictionaryFile = value;
                if (String.IsNullOrEmpty(dictionaryFile) || _dictionaryFile.StartsWith("."))
                {
                    dictionaryFile = Thread.CurrentThread.CurrentCulture.Name;
                }
                // add the default file extension
                if (!dictionaryFile.EndsWith(".dic"))
                {
                    dictionaryFile += ".dic";
                }
                _initialized &= _dictionaryFile.Equals(dictionaryFile);
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public Dictionary<string, Word> UserWords
        {
